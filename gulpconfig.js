...
// Project paths
var project     = 'never-ever',               // The directory name for your theme;
...
module.exports = {
  ...
  browsersync: {
    ...
    proxy: 'never-ever:8888/', // We need to use a proxy instead of the built-in server because WordPress has to do some server-side rendering for the theme to work
    watchOptions: {
  ...
  gitdeploy: {
    ...
    // return gulp.src(dist)
      // pipe(deploy({
        repository: 'https://github.com/isaacmartin/never-ever-live.git'
      // }));
  },
