...
function never_ever_setup() {
  ...
  register_nav_menu( 'header', __( 'Header menu', 'never_ever' ) );
  register_nav_menu( 'footer', __( 'Footer menu', 'never_ever' ) );

}
add_action( 'after_setup_theme', 'never_ever_setup', 11 );
